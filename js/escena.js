...
let esferaCubo,cubo,esfera, octogono;
let angulo = 0;
...
function loadScene()
{
    ...
    // Suelo
    const suelo = new THREE.Mesh( new THREE.PlaneGeometry(15,15, 15, 15), material);
    ...
    octogono = new THREE.Mesh( new THREE.OctahedronGeometry(2,2,2), material);
    esfera.position.x = 1;
    cubo.position.x = -1;
